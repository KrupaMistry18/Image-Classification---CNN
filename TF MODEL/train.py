...
from utils import shuffle, gen_indices, NeatPrinter

model = model()
model.summary()
model.load_weights('D:/3rd sem/sgp/Final SGP/Image-Classification-Using-CNN-master/MODEL DATA/tf-model.h5')
...
model.save_weights('D:/3rd sem/sgp/Final SGP/Image-Classification-Using-CNN-master/MODEL DATA/tf-model.h5')
